...
#include "radio_calibration_messages.h"
#include "log.h"

namespace mavsdk {

RadioCalibrationStatustextParser::RadioCalibrationStatustextParser() {}

RadioCalibrationStatustextParser::~RadioCalibrationStatustextParser() {}

bool RadioCalibrationStatustextParser::parse(const std::string& statustext)
{
...
void RadioCalibrationStatustextParser::reset()
{
    _status = Status::None;
    _progress = NAN;
...
bool RadioCalibrationStatustextParser::is_relevant(const std::string& statustext)
{
...
bool RadioCalibrationStatustextParser::check_started(const std::string& statustext)
{
...
bool RadioCalibrationStatustextParser::check_done(const std::string& statustext)
{
...
bool RadioCalibrationStatustextParser::check_failed(const std::string& statustext)
{
...
bool RadioCalibrationStatustextParser::check_cancelled(const std::string& statustext)
{
...
bool RadioCalibrationStatustextParser::check_progress(const std::string& statustext)
{
    int progress_int;
...
bool RadioCalibrationStatustextParser::check_instruction(const std::string& statustext)
{
